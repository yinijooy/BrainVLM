...
python project/training/run_inference_umbrella.py \
    --config_path /pscratch/sd/h/heehaw/BrainVLM/UMBRELLA_gemini/project/config/umbrella_llava_train_SexClassification.yaml \
    --model_path /pscratch/sd/h/heehaw/BrainVLM/UMBRELLA_gemini/hf_results/umbrella_SexClassification/checkpoint-350 \
    --data_path ./sample_data/sex_classification_conversations_100subjects/test_conversations.jsonl \
    --modality sMRI \
    --output_file /pscratch/sd/h/heehaw/BrainVLM/UMBRELLA_gemini/eval_predictions_SexClassification_100subjects/prediction_results_ckpt350.jsonl
