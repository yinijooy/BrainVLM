...
python project/training/main_umbrella_training.py \
      ...
      --train-data ./sample_data/sex_comparison_conversations_mixed_100subjects_20samples/train_conversations.jsonl \
      --eval-data ./sample_data/sex_comparison_conversations_mixed_100subjects_20samples/validation_conversations.jsonl \
      --modality sMRI \
      --output-dir ./hf_results/umbrella_SexMixed_100subjects_20samples \
      --eval-output-dir ./eval_predictions_SexMixed_100subjects_20samples
